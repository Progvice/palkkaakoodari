import { Employee, employeeModifiable, employeeRequiredFields } from "./employee.entity";
import { updateEmployeeByUUID, insertEmployee, findEmployeeByUUID } from "./employee.repository";
